...
const Footer = () => {
  return (
    <footer className="bg-marketplace-primary text-white pt-12 pb-8">
      <div className="marketplace-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">AgentMarket</h3>
            <p className="text-gray-300 mb-4">
              The premier marketplace for AI agents and solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/for-developers" className="text-gray-300 hover:text-white">
                  For Developers
                </Link>
              </li>
              <li>
